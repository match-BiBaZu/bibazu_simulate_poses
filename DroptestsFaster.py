...
class DroptestsFaster:
    ...
    def get_angular_velocity_array(self):
    ...
    def drop_tests(self):
        ...
        workpiece_data_path = self.data_path / (
            'alpha_' + str(self.Alpha) +
            '_beta_' + str(self.Beta) +
            '_feed_speed_' + str(self.workpiece_feed_speed) +
            '_nozzle_offset_' + str(self.nozzle_offset_perpendicular) +
            '_nozzle_force_' + str(self.nozzle_impulse_force) + '_' + 
            self.workpiece_name + '_simulated_data.txt')
        
        workpiece_angular_velocity_path = self.data_path / (
            'alpha_' + str(self.Alpha) +
            '_beta_' + str(self.Beta) +
            '_feed_speed_' + str(self.workpiece_feed_speed) +
            '_nozzle_offset_' + str(self.nozzle_offset_perpendicular) +
            '_nozzle_force_' + str(self.nozzle_impulse_force) + '_' + 
            self.workpiece_name + '_simulated_data_export_angular_velocity.txt')
        
        workpiece_quaternion_path = self.data_path / (
            'alpha_' + str(self.Alpha) +
            '_beta_' + str(self.Beta) +
            '_feed_speed_' + str(self.workpiece_feed_speed) +
            '_nozzle_offset_' + str(self.nozzle_offset_perpendicular) +
            '_nozzle_force_' + str(self.nozzle_impulse_force) + '_' + 
            self.workpiece_name + '_simulated_data_export_quaternion.txt')
        
        workpiece_location_path = self.data_path / (
            'alpha_' + str(self.Alpha) +
            '_beta_' + str(self.Beta) +
            '_feed_speed_' + str(self.workpiece_feed_speed) +
            '_nozzle_offset_' + str(self.nozzle_offset_perpendicular) +
            '_nozzle_force_' + str(self.nozzle_impulse_force) + '_' + 
            self.workpiece_name + '_simulated_data_export_location.txt')
